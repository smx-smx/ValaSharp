...
namespace CCodeGen.Modules
{
	public class GDBusModule : GVariantModule
	{
		...
		CCodeExpression get_method_info(ObjectTypeSymbol sym) {
			...
			foreach (Method m in sym.get_methods()) {
				...
				foreach (Parameter param in m.get_parameters()) {
					...
					cdecl = new CCodeDeclaration("const GDBusArgInfo");
			...
			cdecl = new CCodeDeclaration("const GDBusMethodInfo * const");
		...
		CCodeExpression get_signal_info(ObjectTypeSymbol sym) {
			...
			cdecl = new CCodeDeclaration("const GDBusSignalInfo * const");
		...
		CCodeExpression get_property_info(ObjectTypeSymbol sym) {
			...
			foreach (Property prop in sym.get_properties()) {
				...
				cdecl = new CCodeDeclaration("const GDBusPropertyInfo");
			...
			cdecl = new CCodeDeclaration("const GDBusPropertyInfo * const");
